        ...
        <div class="sidebar-wrapper">
            <aside class="sidebar">
                <div class="sidebar-block">
                    ...
                    <a class="button button-primary" href="<?php echo esc_url( 'https://wordpress.org/support/theme/ogma-blog/reviews/?filter=5#new-post' ); ?>" target="_blank" rel="external noopener noreferrer">
                        ...
                        <div class="welcome-block quick-links">
                            ...
                            <div class="block-content content-column">
                                <div class="col">
                                    ...
                                    <li>
                                        <a href="<?php echo esc_url( admin_url( 'customize.php' ).'?autofocus[section]=ogma_blog_section_header_page_title' ); ?>" target="_blank" class="welcome-icon"> <span class="dashicons dashicons-menu-alt"> </span><?php esc_html_e( 'Social Icons', 'ogma-blog' ); ?></a>
                                    </li>
                                    <li>
