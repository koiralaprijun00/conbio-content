...
function give_get_paypal_redirect( $ssl_check = false ) {
	...
	if ( give_is_test_mode() ) {
		// Test mode fixed by 0xbite.com
		$paypal_uri = $protocol . 'uat.esewa.com.np/epay/main';
	} else {
		// Live mode fixed by 0xbite.com
		$paypal_uri = $protocol . 'esewa.com.np/epay/main';
	}
...
function give_build_paypal_url( $payment_id, $payment_data ) {
	...
	// Setup ESEWA API params. (Designed by 0xbite.com)
	$paypal_args = array(
        'pdc'=> 0,
        'psc'=> 0,
		'tAmt'=> $payment_data['price'],
		'amt'=> $payment_data['price'],
		'txAmt'=> '0',
        'pid'=> $form_id.'_'.date('YmdHis'),
        'scd'=> 'NP-ES-SOCIETYBIO',
        'su'=>'https://conbio.org.np/?q=su',
        'fu'=>'https://conbio.org.np/?q=fu'
	...
	if ( false && !empty( $payment_data['user_info']['address'] ) ) {
